...
extern void packagelist_lock(void *g_packagelist_data);
extern void packagelist_unlock(void *g_packagelist_data);
extern void* get_pkgl_dat_pkglid(void *pkgl_id);
